...
- ✅ **Единая обработка ошибок** (Global Exception Handling) возвращающая JSON с HTTP статусами (400, 404, 409, 500)
...
1. Клонируйте репозиторий:
   ```bash
   git clone [https://github.com/XanderGI/CurrencyExchange.git](https://github.com/XanderGI/CurrencyExchange.git)
   cd CurrencyExchange
   ```
